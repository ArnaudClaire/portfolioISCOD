...
proofs: [
  {
    ...
    description: `J’ai développé avec Angular des interfaces de consultation permettant aux utilisateurs d’accéder à des données issues du CRM Dynamics 365 via un back-end en .NET, en structurant les écrans et les composants afin de rendre lisibles et exploitables des informations métier parfois complexes.`,
    result: `Résultat : les utilisateurs disposaient d’interfaces claires et cohérentes facilitant la consultation quotidienne des données, ce qui a amélioré leur autonomie et réduit les besoins de support.`,
    link: '/real/aplus-energies',
  },{
  title: 'Intégration du front-end Angular dans une application .NET',
  description: `J’ai participé à la mise en place d’une architecture où le front-end Angular, développé en TypeScript, était compilé puis intégré sous forme de fichiers de distribution dans une application .NET avant déploiement sur Azure.`,
  result: `Résultat : une application cohérente et facilement déployable, avec une séparation claire entre le front-end et les services back-end, tout en respectant les contraintes techniques de l’entreprise.`,
  link: '/real/deploiement-azure',
}

]
,
selfCritique: `
Aujourd’hui, j’estime avoir un niveau intermédiaire à avancé sur Angular, avec une utilisation déjà réalisée en contexte professionnel par le passé, complétée par des projets personnels plus récents. Je maîtrise les concepts fondamentaux du framework, la structuration des projets, le fonctionnement des composants, des pipes et l’organisation globale du code, même si cette compétence n’a pas encore été mobilisée directement dans le cadre de mon année de master.
...
L’acquisition de cette compétence a été relativement rapide une fois les bases assimilées, notamment grâce aux conventions claires du framework et à son outillage intégré, comme la génération de composants et la structuration standardisée des projets. Les projets professionnels passés et les projets personnels menés ensuite m’ont permis de consolider ces acquis et de gagner en autonomie.

Avec le recul, je considère qu’Angular demande un investissement initial plus important que d’autres frameworks front-end, mais qu’il offre en contrepartie une excellente stabilité et une forte maintenabilité. Mon conseil, pour moi-même comme pour d’autres développeurs, serait de bien comprendre l’architecture globale du framework dès le départ afin de tirer pleinement parti de ses forces sur des projets de moyenne ou grande envergure.
`,
evolution: `
